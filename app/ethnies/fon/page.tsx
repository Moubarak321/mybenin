...
import Link from "next/link";
import Image from "next/image";
import { ArrowLeft, Play, Pause, Volume2, X, MapPin, Users, Calendar, MessageCircle, Globe } from "lucide-react";
...
export default function FonDetailPage() {
  ...
  const openGalleryModal = (image: { url: string; caption: string }): void => {
    setSelectedImage(image);
    document.body.style.overflow = 'hidden';
    };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-amber-50 to-orange-50">
      ...
      <div className="relative h-96 overflow-hidden">
        <div className="absolute inset-0 bg-black">
          <Image 
            src="https://images.unsplash.com/photo-1578353022142-09264fd64295?q=80&w=1965" 
            alt="Culture Fon"
            fill
            className="object-cover opacity-70"
          />
          ...
          {activeTab === 'overview' && (
            ...
            >
              ...
              <div className="prose prose-lg max-w-none text-gray-700">
                ...
                <div className="my-12 relative rounded-xl overflow-hidden shadow-lg">
                  <Image
                    src="https://dlc.services/iiif-img/16/6/40852_1727020590407/full/1024,581/0/default.jpg"
                    alt="Art royal Fon"
                    width={800}
                    height={500}
                    className="w-full h-auto object-cover"
              ...
              <div className="prose prose-lg max-w-none text-gray-700">
                ...
                <div className="grid md:grid-cols-2 gap-8 my-12">
                  ...
                  <div className="bg-white rounded-xl overflow-hidden shadow-md">
                    <div className="h-48 relative">
                      <Image
                        src="https://i.pinimg.com/736x/3f/81/92/3f819245ec19f229220bc6075fbe0e0d.jpg"
                        alt="Art Fon"
                        fill
                        className="object-cover"
                      />
      ...
      {/* <div className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              <h3 className="text-xl font-semibold mb-4 text-amber-400">À propos</h3>
              <p className="text-gray-300">Explorez la diversité culturelle du Bénin à travers ses différentes ethnies et traditions.</p>
            </div>
            
            <div>
              <h3 className="text-xl font-semibold mb-4 text-amber-400">Autres ethnies</h3>
              <ul className="space-y-2">
                <li><Link href="/ethnies/yoruba" className="text-gray-300 hover:text-amber-400 transition-colors">Yoruba</Link></li>
                <li><Link href="/ethnies/bariba" className="text-gray-300 hover:text-amber-400 transition-colors">Bariba</Link></li>
                <li><Link href="/ethnies/dendi" className="text-gray-300 hover:text-amber-400 transition-colors">Dendi</Link></li>
                <li><Link href="/ethnies/adja" className="text-gray-300 hover:text-amber-400 transition-colors">Adja</Link></li>
                <li><Link href="/ethnies/somba" className="text-gray-300 hover:text-amber-400 transition-colors">Somba</Link></li>
              </ul>
            </div>
            
            <div>
              <h3 className="text-xl font-semibold mb-4 text-amber-400">Contact</h3>
              <p className="text-gray-300 mb-2">Pour plus d'informations sur les ethnies du Bénin et les visites culturelles.</p>
              <Link href="/contact" className="inline-flex items-center text-amber-400 hover:text-amber-300">
                Nous contacter <ArrowLeft className="ml-2 h-4 w-4" />
              </Link>
            </div>
          </div>
          
          <div className="mt-12 pt-8 border-t border-gray-800 text-center text-gray-400">
            <p>© {new Date().getFullYear()} Diversité Culturelle du Bénin. Tous droits réservés.</p>
          </div>
        </div>
      </div> */}
    </div>
